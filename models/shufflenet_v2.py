...
class ShuffleNetV2(nn.Module):
    ...
    def __init__(self, scale=1.0, in_channels=3, c_tag=0.5, num_classes=1000, activation=nn.ReLU,
        ...
        :param scale: 1.0
        :param in_channels: 3
        :param c_tag: 0.5 | 1.0 | 1.5 | 2.0
        :param num_classes: 1000
        :param activation: nn.ReLU
        :param SE: False | True
        :param residual: False | True
        :param groups: 2
        """
        ...
        self.fc = nn.Linear(self.c[-1], 1, bias=False)
...
def shufflenetV2(scale=0.5, c_tag=0.5, num_classes=101, SE=False, residual=False):
    model = ShuffleNetV2(scale=scale, in_channels=3, c_tag=c_tag, num_classes=num_classes, SE=SE, residual=residual)
    return model
