...
from models.mobilenet import mobilenet_v2 as net
...
def main():
    ...
    # val_writer = SummaryWriter(str(PATH.joinpath('log', 'val')))
    # test_writer = SummaryWriter(str(PATH.joinpath('log', 'test')))
    # writers = {
    #     'train': train_writer,
    #     'valid': val_writer,
    #     'test': test_writer
    ...
    model = net(num_classes, False)
    model = model.to(DEVICE)
    logger.info(torchsummary.summary(model, (3, img_size, img_size)))
