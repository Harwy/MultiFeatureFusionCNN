...
from models.resnet34lite1 import resnet34 as resnet
from models.resnet34lite1 import train, test

"""
resnet34_lite_1
修改loss为DLDLv2_pytorch中的kl_loss
"""
...
def main():
    ...
    # lr_scheduler = optim.lr_scheduler.MultiStepLR(optimizer,milestones=[30, 100, 200], gamma=0.1)
